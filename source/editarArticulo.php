...
try {
    ...
    $consulta->editarArticulo($peticion->getPost('id'), $peticion->getPost('codigo'), $peticion->getPost('articulo'), $peticion->getPost('descripcion'), $peticion->getPost('usuario_id'));
